...
def train(source_loader, target_train_loader, target_test_loader, model, optimizer):
    ...
    for e in range(args.n_epoch):
        ...
        for mlen in range(n_batch):
            ...
            optimizer.zero_grad()
            label_source_pred, transfer_loss, cmmd_loss,sim_matrix, estimated_sim_truth = model(e,data_source, data_target,label_source)
            ...
            loss = clf_loss + beta*transfer_loss+ cmmd_weight*cmmd_loss + cls_loss
        ...
        print('Epoch: [{:2d}/{}], cls_loss: {:.4f}, transfer_loss: {:.4f}, train_loss_cmmd_loss: {:.4f},train_loss_cls: {:.4f},total_Loss: {:.4f}, acc: {:.4f}'.format(
                 e, args.n_epoch, train_loss_clf.avg, train_loss_transfer.avg, train_loss_cmmd_loss.avg, train_loss_cls.avg,
...
if __name__ == '__main__':
    ...
    for i in range(15):
        ...
        #setup_seed(20)
        model = model_mkmmd_cmmd_1.Transfer_Net(
